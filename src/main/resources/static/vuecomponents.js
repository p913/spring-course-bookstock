...
Vue.component('add-comment-form', {
  ...
  template: `<form class="add-comment-form" v-on:submit.prevent="newCommentClick">
            <input type="text" v-model="userName" class="add-comment-form__name" placeholder="Ваше имя..." required><br>
            <textarea v-model="commentText" class="add-comment-form__text" placeholder="Ваш отзыв..." required rows="5"></textarea><br>
...
Vue.component('search-form', {
  ...
  template: `<form class="search-form" v-on:submit.prevent="$emit('search', searchText)">
            <input type="text" v-model="searchText" class="search-form__text" v-bind:placeholder="prompt" required>
...
Vue.component('edit-book-form', {
  ...
  template: `<form class="edit-book-form" v-on:submit.prevent="book.author.id = null; $emit('save', book);">
            <div class="edit-book-form__row">
              <label class="edit-book-form__label" for="edit-book-form-title">Наименование: </label>
              <input id="edit-book-form-title" type="text" v-model="book.title" class="edit-book-form__input-title" required>
            ...
            <div class="edit-book-form__row">
              ...
              <input id="edit-book-form-author" list="edit-book-form-authors" type="search" v-model="book.author.name" class="edit-book-form__input-author" required>
            ...
            <div class="edit-book-form__row">
              ...
              <input id="edit-book-form-genre" type="text" v-model="book.genre" class="edit-book-form__input-genre" required>
            ...
            <div class="edit-book-form__row">
              ...
              <input id="edit-book-form-publisher" type="text" v-model="book.publisher" class="edit-book-form__input-publisher" required>
            ...
            <div class="edit-book-form__row">
              ...
              <input id="edit-book-form-year" type="number" v-model="book.year" class="edit-book-form__input-year" required min="1800" v-bind:max="new Date().getFullYear()">
            ...
            <div class="edit-book-form__row">
              ...
              <input id="edit-book-form-isbn" type="text" v-model="book.isbn" class="edit-book-form__input-isbn" required>
