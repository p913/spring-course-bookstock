package com.pvil.otuscourse.batchpgsql2mongo.domain.target;
...
public class Commentary {
    ...
    public Commentary(String text, Date date, User reader) {
        this.text = text;
        this.date = date;
        this.reader = reader;
    }

    public Commentary(String id, String text, Date date, User reader) {
        this.id = id;
        this.text = text;
        this.date = date;
        this.reader = reader;
