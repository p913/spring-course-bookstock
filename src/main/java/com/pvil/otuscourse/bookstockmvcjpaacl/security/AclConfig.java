...
public class AclConfig {
    ...
    public AclAuthorizationStrategy aclAuthorizationStrategy() {
        return new AclAuthorizationStrategyImpl(new SimpleGrantedAuthority("ROLE_STOCK_KEEPER"));
    }
    ...
    public JdbcMutableAclService aclService() {
        ...
        //Хак для поддержки работы в postgresql числовых id у бизнес-сущности совместно с стороковым полем object_id_identity в таблице  acl_object_identity
