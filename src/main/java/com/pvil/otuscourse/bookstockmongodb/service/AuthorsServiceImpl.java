...
import com.pvil.otuscourse.bookstockmongodb.repository.AuthorRepository;
    ...
    public Author getExistingElseCreate(Author author) {
        if (author.getId() > 0) {
            ...
            if (founded.isEmpty())
                ...
                throw new EntityNotFoundException(String.format("Author with Id = %d is different author than %s (%s)",
