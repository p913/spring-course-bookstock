...
public class EtalonBooksForTests {
    ...
    static List<Book> books = Arrays.asList(
            new Book(new ObjectId().toHexString(), "Harry Potter and the Sorcerer's Stone", "590353427", "Scholastic, Inc.", 1999,
                    ...
                    Arrays.asList(new Commentary(new ObjectId().toHexString(), "Best book!", commentsDate, EtalonUsersForTests.getReferenceToReader()),
                            new Commentary(new ObjectId().toHexString(), "Bad!Bad!Bad!", commentsDate, EtalonUsersForTests.getReferenceToReader()))),
    ...
    public static Commentary getCommentCanBeAdded() {
        return new Commentary("Added", commentsDate, EtalonUsersForTests.getReferenceToReader());
    }
